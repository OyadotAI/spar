...
export function ConfirmSheet() {
  ...
  return (
    <Sheet label={ask.title} width={460} onClose={() => close(false)} dirty={!!need && typed.length > 0}>
      <div onKeyDown={(e) => { if (e.key === 'Enter' && ready) { setTyped(''); close(true) } }}>
        ...
        {need && (
          <label className="col" style={{ gap: 4, fontSize: 'var(--small)', color: 'var(--dim)' }}>
