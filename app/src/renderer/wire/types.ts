...
export type StatementResult = { id: number; state: string; code?: string; progress?: number; startedOn?: number | string; completedOn?: number | string; output?: { status?: string; errorName?: string; errorValue?: string; traceback?: string[]; text?: string }; note?: string }
